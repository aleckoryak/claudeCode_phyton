...
file_metadata = upload("./images/streaming.csv")
print (file_metadata)
...
result = chat(messages, tools=[{"type": "code_execution_20250825", "name": "code_execution"}])

print (result)

# check code_execution_output in the result
